      ...
      >
        ...
        <div class="mt-5" style="margin-left: -30px">
          <v-btn @click="clickReq" text depressed rounded>
            ...
            <span style="color: #0000cd">Click here for renewal books</span>
          </v-btn>
        </div>
      </div>
        ...
        >
          <v-card-text>
            ...
            <v-row no-gutters align-md="center" class="ma-0 pa-0">
              <v-col cols="8">Cancle Renewal Request:</v-col>
              <v-col cols="3">
                <v-checkbox
                  v-model="Selection"
                  color="info"
    ...
    export default {
     ...
     methods: {
      loadData(){
         ...
         getUserReqRenewalBooks(data,"Renewal").then(res => {
      ...
      removeCartClick(){
        ...
        removeRenewalReqBooks(userId,this.Selection,"Renewal").then(res=>{
